          ...
          <div>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
              {rooms.map(room=>{
                ...
                const occ=!!tr;
                return(
                  <div key={room.id} onClick={()=>occ&&setDetModal(tr)} style={{background:"#fff",borderRadius:12,padding:"12px",border:`1.5px solid ${occ?c+"66":c+"22"}`,cursor:occ?"pointer":"default"}}>
